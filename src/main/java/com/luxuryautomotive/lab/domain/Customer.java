...
@Data
@NamedQueries(
	@NamedQuery(name ="getCustomerByDealer", query = "select c from Customer c where exists(select 1 from Order o where c.customer_id = o.customer_id and o.dealer_email=:email)")
)
